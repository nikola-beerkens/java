...
public class StreamsTest {
    ...
    public void countEvenNumbers() {
        ...
        long result = Stream
                .of(PI)
                .mapToInt(Integer::intValue) // transform the stream to int stream
                .filter(n -> n % 2 == 0) // filter even elements
                .count(); // count the number of even elements
    ...
    public void sumOddNumbers() {
        ...
        int result = Stream
                .of(PI)
                .mapToInt(Integer::intValue) // transform the stream to int stream
                .filter(n -> n % 2 != 0) // filter odd elements
                .sum(); // sum em up
    ...
    public void multiplyNumbers() {
        ...
        int result = Stream
                ...
                .limit(5)
                .reduce(1, (a, b) -> a * b); // multiply elements together
    ...
    public void calculateTax() {
        ...
        Double result = Stream
                .of(prices)
                .map(price -> price * (1 + tax)) // tax inclusive
    ...
    public void streamOfStreams() {
        ...
        int result = Stream
                .of(input)
                .flatMapToInt(Arrays::stream) // flatten the arrays and convert to int stream
                .sum(); // compute the sum
    ...
    public void everySecondElement() {
        ...
        List<Integer> result = IntStream
                .range(0, input.size())
                .filter(n -> n % 2 == 0) // filter even elements
                .mapToObj(input::get) // replace indexes with elements from input list
    ...
    public void philosophers() {
        ...
        Map<String, String> result = philosophers
            .entrySet()
            .stream()
            .filter(e -> e.getValue().equals("Greek"))
